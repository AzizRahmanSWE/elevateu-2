    ...
    <div className="min-h-full bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 py-8 px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            <span className="text-purple-400 text-sm font-medium">Almost there! ✨</span>
          </motion.div>
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">
            Complete Your Profile
          </h1>
          <p className="text-gray-400 max-w-md mx-auto">
            Help us personalize your fitness journey with AI-powered workouts tailored just for you
          </p>
        </div>
